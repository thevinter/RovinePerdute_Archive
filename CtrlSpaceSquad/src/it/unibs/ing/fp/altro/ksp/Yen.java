...
import it.unibs.ing.fp.altro.Edge;
import it.unibs.ing.fp.altro.Graph;
import it.unibs.ing.fp.altro.util.Dijkstra;
...
public final class Yen implements KSPAlgorithm {
     ...
     */
    public List<Path> ksp(it.unibs.ing.fp.altro.Graph graph, String sourceLabel, String targetLabel, int K) {
        ...
        try {
            ...
            for (int k = 1; k < K; k++) {
                ...
                ProgressBar.value(Math.abs(k*10/K));
